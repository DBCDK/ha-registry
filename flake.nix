...
# SPDX-License-Identifier: EUPL-1.2
{
  ...
  inputs = {
    # until https://nixpk.gs/pr-tracker.html?pr=361052 lands
      ...
      (
        ...
        rec {
          ...
          devShells.default = craneLib.devShell {
            ...
            packages = with pkgs; [ rustup toolchain cargo-deny just zip reuse pkg-config openssl statix convco cargo-outdated ] ++ self.checks.${system}.pre-commit-check.enabledPackages;
